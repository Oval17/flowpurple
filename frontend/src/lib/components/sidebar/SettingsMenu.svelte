<script lang="ts">
	...
	// FlowPurple personal build: hide Workers/Logs links and the external Help
	// menu (upstream Docs/Discord/Issues/Changelog links).
...
<!-- Workers and Logs are full pages (not account/instance actions), so they sit
     ...
     FlowPurple lite build hides this whole block. -->
{#if !FLOWPURPLE_LITE}
