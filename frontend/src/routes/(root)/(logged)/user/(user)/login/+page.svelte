...
<!-- FlowPurple: purple gradient backdrop with a white login card. The heading keeps
     dark text, so it stays readable on the card in both modes. -->
<div
	class="flex flex-col pt-24 pb-12 sm:px-6 lg:px-8 relative min-h-screen bg-gradient-to-br from-violet-700 via-purple-600 to-indigo-900"
>
	...
	<div class="sm:mx-auto sm:w-full sm:max-w-sm bg-white rounded-2xl shadow-2xl px-8 py-8">
